...
assert(areAnagrams("Sujitha","sujitha"))
assert(areAnagrams("abaa","AbAA"))
assert(areAnagrams("aabb","baba"))
assert(areAnagrams("santosh","santhosham"),False)
print("All test cases are passes")